<template>
  <template v-if="isStudent">
    ...
    <ul class="list-decimal p-3">
      ...
      <li>
        Scoring Pattern -- Correct Answer: +4, Wrong Answer: -1, Skipped: 0
      </li>
      <li class="text-red-600">
        During the test, to confirm your answer please click
        <b>SAVE & NEXT</b>. Your response to a question will not be considered
        incase you fail to save your answer.
      </li>
      <li>
        Only press <b>END TEST</b> once you have completed and reviewed your
        answers. You will not be able to change your responses once you click on
        <b>END TEST</b>
      </li>
    </ul>
  </template>
  <template v-else>
    ...
    <ul class="list-decimal p-3">
      <li>
        The total number of questions you can attempt will appear on your screen
        before starting the test.
      </li>
      <li>
        You will receive information on duration of the test from Avanti
        Fellow's team before the test. There will also be a timing running once
        you start the test.
      </li>
      ...
      <li>
        ...
        answer. No marks will be awarded if a question is not attempted.
      </li>
    </ul>
  </template>
</template>
