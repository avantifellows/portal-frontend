...
export default {
  ...
  async created() {
     ...
     */
    if (this.sessionId != "") {
      if (this.sessionId.startsWith("PunjabStudents") || this.sessionId.startsWith("CD_Hiring") || this.sessionId.startsWith("AFTesting") || this.sessionId.startsWith("PunjabTeachers")) {
        this.oldFlow = true;
