...
export const verifyCandidateEndpoint = "/candidate/verify";
export const userSignupEndpoint = "/user/";
export const verifySchoolEndpoint = "/school/verify";
export const getStudentEndpoint = "/student";
export const getTeacherEndpoint = "/teacher";
export const getCandidateEndpoint = "/candidate";
export const getSchoolEndpoint = "/school";
